...
INSERT INTO `usuarios` (`id`,`nome`,`CPF`, `email`, `senha`, `telefone`, `dataNasc`, `escolaridade`, `genero`, `admin`) VALUES
...
INSERT INTO `endereco` (`usuario_id`, `cep`, `cidade`, `bairro`, `UF`, `rua`,`numero`, `complemento`) VALUES
(1, '50751-125', 'Recife', 'Bongi', 'PE', 'Rua adilson Santos Xavier', 4,null),
(2, '69314-338', 'Boa Vista', 'Doutor Sílvio Leite', 'RR', 'Rua Raimundo de Castro Barros', 721,null),
(3, '52050-970', 'Recife', 'Graças', 'PE', 'Rua José Clementino 106', 130,'Torre B'),
(4, '68903-881', 'Macapá', 'Araxá', 'AP', 'Alameda Meridional do Norte', 167,null),
(5, '73081-685', 'Brasília', 'Setor de Mansões de Sobradinho', 'DF', 'Quadra QMS 11C Módulo B', 601,'Bloco A'),
(6, '58055-018', 'João Pessoa', 'Mangabeira', 'PB', 'Avenida Hilton Souto Maior', 727,null),
(7, '59156-222', 'Parnamirim', 'Cajupiranga', 'RN', 'Rua Caminho da Lapa', 356,null),
(8, '94435-580', 'Viamão', 'Jardim Krahe', 'RS', 'Rua Salto do Jacui', 517,"Apt. 05"),
(9, '99700-548', 'Erechim', 'Ipiranga', 'RS', 'Rua José Pigozzo', 989,"Bloco C"),
(10, '68909-877', 'Macapá', 'Marabaixo', 'AP', 'Travessa São Benedito', 120,"Bloco D")
;
...
INSERT INTO `perguntas` (`idperguntas`, `pergunta`, `alternativas`, `proximapergunta`) VALUES
(1, 'Em que nível você acredita que se encontra?', null, null),
...
INSERT INTO `videos` (`idvideos`,  `url`, `titulo`,`trilha_idtrilha`) VALUES
